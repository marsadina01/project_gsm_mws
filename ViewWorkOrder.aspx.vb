        ...
        If Not String.IsNullOrEmpty(status) AndAlso IsNumeric(status) Then
            If role = "teknisiGS" OrElse role = "teknisiSup" Then
                ...
                ElseIf status = 6 Then
                    buttons &= "<button type='button' class='btn btn-primary btn-sm' title='Edit' style='margin-right: 5px;' onclick='respondToWorkOrder(""" & workOrderNo & """)'>"
            ...
            If role = "requester" Then
                If status = 1 Then
                    ...
                    buttons &= "<button type='button' class='btn btn-primary btn-sm' title='Edit' style='margin-right: 5px;' onclick='cancelWorkOrder(""" & workOrderNo & """)'>"
                    buttons &= "<i class='fa fa-edit'></i></button>"
